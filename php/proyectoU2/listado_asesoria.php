...
<body>
    ...
    <div class="container mt-5">
        ...
        <div class="mb-3">
            <a href="alta_asesoria.php" class="btn btn-success mb-3">Agregar Asesoría</a>
            <a href="excel_asesoria.php" class="btn btn-success mb-3">Exportar .xslx</a>
        </div>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?= $row['fecha']?></td>
                        <td>
                            <a href="editar_asesoria.php?id=<?= $row['id'] ?>" class="btn btn-primary">Editar</a>
                            <br>
                            <br>
                            <form class="d-inline-block" action="crud.php?baja_asesoria=<?= $row['id'] ?>" method="post">
